---
title: "Assessment 1: Essay Plan"
description: "A structured plan for your final essay to help develop a focused research strategy."
---

**Weighting:** 10%  
**Length:** Maximum 2 pages A4  
**Deadline:** Thursday 19th March, 23:59  
**Feedback Expected:** 10th April  

## Task Description

Before completing this plan, carefully read the **Long Essay (Assessment 3)** description to understand what the final essay requires.

Submit a structured plan for your final essay. You must include:

1.  Your chosen essay question - either select from the provided options OR propose your own question (subject to instructor approval)
2. A clear thesis statement that directly answers the question
3. An outline of your main arguments (3-4 key points with brief explanations)
4. The 2-3 cases you will examine comparatively, with brief justification for case selection
5. A preliminary bibliography of 5-7 key sources (mix of course readings and additional research) - **Bibliography is included in the word count**

This plan helps you develop a focused research strategy and receive feedback before writing the final essay. It should demonstrate:

- A viable analytical argument (not just description)

- Appropriate case selection that enables comparison

- Engagement with relevant theoretical frameworks from the course

- Evidence that you've begun identifying suitable sources

**Note**: If proposing your own question, ensure it: (a) requires comparative analysis of 2-3 cases, (b) engages with course theories/concepts, and (c) is answerable in 3000 words. Self-designed questions will be approved (or require revision) through feedback on this essay plan.

**Good case selection is crucial**: choose cases that vary on the outcome you want to explain, or that test theoretical claims in different contexts. Avoid cases that are too similar (no analytical leverage) or too different (too many confounding variables).
